sap.ui.define([
    ...
    function (Controller, Device, JSONModel, Filter, Sorter, Fragment) {
        ...
        return Controller.extend("tbspl.ppaplanning.controller.Form2", {
            ...
            onToggleTableSection: function(oEvent) {
                oEvent.getSource().getParent().getParent().setMode(oEvent.getParameter("pressed") ? "MultiSelect" : "None");
            },
            ...
            handleSortButtonPressed: function () {
                this.getViewSettingsDialog("tbspl.ppaplanning.view.fragment.SortDialog")
            ...
            handleGroupButtonPressed: function () {
                this.getViewSettingsDialog("tbspl.ppaplanning.view.fragment.GroupDialog")
                    .then(function (oViewSettingsDialog) {
                        oViewSettingsDialog.open();
                    });
            },
