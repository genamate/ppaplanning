		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PPA Planning",
									"targetURL": "#tbsplppaplanning-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tbsplppaplanning-display": {
								"semanticObject": "tbsplppaplanning",
								"action": "display",
								"description": "Tata BlueScope Steel: PPA Planning",
								"title": "PPA Planning",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tbspl.ppaplanning",
									"url": sap.ui.require.toUrl("tbspl/ppaplanning")
								}
							}
						}
					}
